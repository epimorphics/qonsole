    ...
    ShadowTable.prototype.head = function () {
        ...
        return (h("thead", { style: this.resetStyle() },
            h("tr", null, this.props.header.columns.map(function (col) {
                return (h("th", { style: __assign(__assign({}, _this.resetStyle()), { whiteSpace: 'nowrap', 
                        // pagination buttons
...
var PipelineProcessor = /** @class */ (function () {
    ...
    PipelineProcessor.prototype.process = function () {
        ...
        trigger.apply(void 0, __spreadArrays([this.beforeProcessCallback], args));
        var result = this._process.apply(this, args);
        trigger.apply(void 0, __spreadArrays([this.afterProcessCallback], args));
        return result;
    };
...
var Pipeline = /** @class */ (function () {
     ...
     * @param fn
     */
    Pipeline.prototype.onError = function (fn) {
...
var Config = /** @class */ (function () {
    function Config(config) {
        var updatedConfig = __assign(__assign({}, Config.defaultConfig()), config);
        this._userConfig = {};
...
var TD = /** @class */ (function (_super) {
    ...
    TD.prototype.render = function () {
        return (h("td", { role: this.props.role, colSpan: this.props.colSpan, className: classJoin(className('td'), this.props.className, this.config.className.td), style: __assign({}, this.config.style.td) }, this.content()));
    };
    return TD;
}(BaseComponent));
...
var TH = /** @class */ (function (_super) {
    ...
    TH.prototype.render = function () {
        ...
        return (h("th", __assign({ className: classJoin(className('th'), this.isSortable() ? className('th', 'sort') : null, this.config.className.th), onClick: this.onClick.bind(this), style: __assign(__assign({}, this.config.style.th), { width: this.props.column.width }), onKeyDown: this.keyDown.bind(this) }, props),
        ...
        if (this.props.header) {
            return (h("thead", { key: this.props.header.id, className: className('thead') },
                h(TR, null, this.props.header.columns.map(function (col, i) {
                    return h(TH, { column: col, index: i });
                }))));
        }
        return null;
    };
...
var HeaderContainer = /** @class */ (function (_super) {
    ...
    HeaderContainer.prototype.render = function () {
        var config = getConfig(this.context);
        if (this.state.isActive) {
            return (h("div", { ref: this.headerRef, className: classJoin(className('head'), this.config.className.header), style: __assign({}, this.config.style.header) },
                h(Search, __assign({}, config.search))));
        }
        return null;
    };
...
var Pagination = /** @class */ (function (_super) {
    ...
    Pagination.prototype.componentWillMount = function () {
        ...
        if (this.props.enabled) {
            ...
            if (this.props.server) {
                ...
                this.config.pipeline.afterProcess(function (result) {
    ...
    Pagination.prototype.componentDidMount = function () {
        var _this = this;
        var config = getConfig(this.context);
        config.pipeline.updated(function (processor) {
            // this is to ensure that the current page is set to 0
            // when a processor is updated for some reason
            if (_this.props.resetPageOnUpdate && processor !== _this.processor) {
                _this.setPage(0);
            }
        });
    };
    ...
    Pagination.prototype.renderPages = function () {
        ...
        return (h(d, null,
            ...
            this.pages > maxCount && this.pages > this.state.page + pagePivot + 1 && (h(d, null,
                h("button", { tabIndex: -1, className: className('spread') }, "..."),
    ...
    Pagination.prototype.renderSummary = function () {
        return (h(d, null, this.props.summary && this.state.total > 0 && (h("div", { role: "status", className: className('summary'), title: this._('pagination.navigate', this.state.page + 1, this.pages) },
    ...
    FooterContainer.prototype.render = function () {
        ...
        if (this.state.isActive) {
            return (h("div", { ref: this.footerRef, className: classJoin(className('footer'), this.config.className.footer), style: __assign({}, this.config.style.footer) },
                h(Pagination, __assign({}, config.pagination))));
        }
        return null;
    };
        ...
        return (h(configContext.Provider, { value: this.props.config },
            h("div", { role: "complementary", className: classJoin('gridjs', className('container'), this.state.status === Status.Loading ? className('loading') : null, this.props.config.className.container), style: __assign(__assign({}, this.props.config.style.container), {
                ...
                h("div", { className: className('wrapper'), style: { width: this.props.width } },
                    h(Table, { data: this.state.data, header: this.state.header, width: this.props.width, status: this.state.status })),
...
export { m as Component, Config, Grid, h as createElement, p as createRef, h, html, l as useEffect, d$1 as useRef };
